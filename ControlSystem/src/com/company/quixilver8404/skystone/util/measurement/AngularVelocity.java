...
public class AngularVelocity {
    public static final AngularVelocity ZERO = new AngularVelocity(0, AngularVelocity.Unit.RADIANS_PER_SEC);
     ...
     */
    public AngularVelocity(double angularVelocity, AngularVelocity.Unit unit) {
     ...
     */
    public double getValue(AngularVelocity.Unit unit) {
    ...
    public static AngularVelocity addAngularVelocities(AngularVelocity addend1, AngularVelocity addend2) {
        return new AngularVelocity(addend1.radiansPerSec + addend2.radiansPerSec, AngularVelocity.Unit.RADIANS_PER_SEC);
    }
    ...
    public static AngularVelocity subtractAngularVelocities(AngularVelocity minuend, AngularVelocity subtrahend) {
        return new AngularVelocity(minuend.radiansPerSec - subtrahend.radiansPerSec, AngularVelocity.Unit.RADIANS_PER_SEC);
    }
}
