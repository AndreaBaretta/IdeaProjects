...
public class PIDController {
    ...
    private int timeoutMillis; // Elapsed time at which this controller will reset
    ...
    /**
     * Cycles this controller, using the current offset and time to adjust this controller as necessassary.
