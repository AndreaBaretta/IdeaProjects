 ...
 * @since 3.0
 */
public class NelderMeadCustom extends AbstractSimplex {
     ...
     */
    public NelderMeadCustom(final int n) {
        this(n, 1d);
    }
     ...
     */
    public NelderMeadCustom(final int n, double sideLength) {
        this(n, sideLength,
     ...
     */
    public NelderMeadCustom(final double[] steps) {
     ...
     * {@link AbstractSimplex#AbstractSimplex(double[][])}.
     */
    public NelderMeadCustom(final double[][] referenceSimplex) {
